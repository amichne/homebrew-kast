...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.10.4/kast-v0.10.4-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.10.4/kast-idea-v0.10.4.zip
```
