...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.12.3/kast-v0.12.3-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.12.3/kast-idea-v0.12.3.zip
```
