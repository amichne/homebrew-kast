...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.11.0/kast-v0.11.0-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.11.0/kast-idea-v0.11.0.zip
```
