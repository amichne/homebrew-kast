...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.11.5/kast-v0.11.5-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.11.5/kast-idea-v0.11.5.zip
```
