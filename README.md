...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast-rs/releases/download/v0.7.16/kast-v0.7.16-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.7.16/kast-intellij-v0.7.16.zip
```
