...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.12.7/kast-v0.12.7-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.12.7/kast-idea-v0.12.7.zip
```
