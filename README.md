...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.11.1/kast-v0.11.1-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.11.1/kast-idea-v0.11.1.zip
```
