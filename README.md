...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.7.39/kast-v0.7.39-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.7.39/kast-idea-v0.7.39.zip
```
