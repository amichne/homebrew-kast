...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.8.2/kast-v0.8.2-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.8.2/kast-idea-v0.8.2.zip
```
