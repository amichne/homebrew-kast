...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.13.0/kast-v0.13.0-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.13.0/kast-idea-v0.13.0.zip
```
