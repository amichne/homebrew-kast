...
```text
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.7.35/kast-v0.7.35-macos-arm64.zip
${HOMEBREW_KAST_ARTIFACT_ROOT}/kast/releases/download/v0.7.35/kast-intellij-v0.7.35.zip
```
