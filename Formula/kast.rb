...
class Kast < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "5e42c6008526829288237cf67bc476a199f9c1571cb086ad120d6278e9ec1602"
    end

    on_arm do
      url "#{cli_release_root}/v#{ARTIFACT_VERSION}/kast-v#{ARTIFACT_VERSION}-macos-arm64.zip"
      sha256 "bdc1a1e921263dc606004dfc904c3692f9bb9a8b9b3e5d691610176224620593"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "8058b7b9315f7ec0b79a9c17b5d63748433a49e87d729763851f51ecb2123434"
    end

    on_arm do
      url "#{cli_release_root}/v#{ARTIFACT_VERSION}/kast-v#{ARTIFACT_VERSION}-linux-arm64.zip"
      sha256 "a12a66f35dbffc0059ad8c8185ea9191c395852bc62e77d2752631c6840d0517"
    end
  end
