...
class Kast < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "41d04851b06f7396dca82d87cf34f361ebf63e735d645c2d55bac341e44d0bc6"
    end

    on_arm do
      url "#{cli_release_root}/v#{ARTIFACT_VERSION}/kast-v#{ARTIFACT_VERSION}-macos-arm64.zip"
      sha256 "c5eebe4f4454a893e923177a0e73696b8eb311e3c6de8fa8a999bc3f0be9615f"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "187d408e51442c95369ce3526c45880c62de22cb3585ede10d554444aae4b391"
    end

    on_arm do
      url "#{cli_release_root}/v#{ARTIFACT_VERSION}/kast-v#{ARTIFACT_VERSION}-linux-arm64.zip"
      sha256 "198e1744d4145b05f2122b6e952b8e2aaa6ce2951d2ad77991f686cf635cb038"
    end
  end
