...
class Kast < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "d24f6310e18705c200a27985bd451e35b3c1865d2695e5748872b5c136d7dab6"
    end

    on_arm do
      url "#{cli_release_root}/v#{ARTIFACT_VERSION}/kast-v#{ARTIFACT_VERSION}-macos-arm64.zip"
      sha256 "ba9f3180a4070033863284e53c17409b016de25ee13565187a6313494f5073a1"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "bfd8a19f12fb85a0c12ad5d53aaa5beeb3923e3291fc3450b913ba13bab411e8"
    end

    on_arm do
      url "#{cli_release_root}/v#{ARTIFACT_VERSION}/kast-v#{ARTIFACT_VERSION}-linux-arm64.zip"
      sha256 "d94e4ffff8ff3f721abbb5ea2c888f960b1f535698ed6d6e249bed25105e20de"
    end
  end
