...
require("release_ready()" in publish, "aligned release workflow must wait for published upstream releases")
require("find_release_run()" in publish, "aligned release workflow must locate upstream release workflow runs")
require("wait_for_release_run amichne/kast push" in publish, "aligned release workflow must wait for the kast release workflow by push")
require("wait_for_release_run amichne/kast-rs push" in publish, "aligned release workflow must wait for the kast-rs release workflow by push")
require('"kast-headless-${tag}.zip"' in publish, "aligned release workflow must download the headless backend asset")
require('"SHA256SUMS"' in publish, "aligned release workflow must wait for upstream checksum assets")
